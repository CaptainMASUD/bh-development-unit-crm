export const ERP_MODULES = [
  ...
  { id: "administration", code: "ADMINISTRATION", name: "Administration", category: "Operations", description: "Company profile, branches, users, roles, permissions, and settings.", permissionPrefixes: ["users", "notifications", "access-control", "profile", "company", "branch", "administration-dashboard", "system-settings"] },
];
