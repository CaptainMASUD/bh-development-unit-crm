...
export const DOCUMENT_NUMBER_TYPES = Object.freeze([
  ...
  define("inventory.unit", "InventoryUnit", "code", "controllers/inventory/inventoryUnit.controller.js", { label: "Unit Code", prefix: "UOM", mode: "manual", maxLength: 50 }),
  ...
  define("inventory.stock-transfer", "StockTransfer", "transferNo", "models/inventory/stockTransfer.model.js", { label: "Request / Transfer Ref.", prefix: "ST", additionalProducers: ["controllers/inventory/stockTransfer.controller.js"] }),
  define("inventory.stock-adjustment", "StockAdjustment", "adjustmentNo", "models/inventory/stockAdjustment.model.js", { label: "Adjustment No.", prefix: "SA", additionalProducers: ["controllers/inventory/stockAdjustment.controller.js"] }),
  define("inventory.stock-movement", "StockMovement", "movementNo", "models/inventory/stockMovement.model.js", { label: "Stock Movement No.", prefix: "SM", additionalProducers: ["controllers/inventory/stockMovement.controller.js"] }),
  define("inventory.quality-inspection", "QualityInspection", "inspectionReference", "controllers/inventory/inventoryOperations.controller.js", { label: "Quality Inspection No.", prefix: "QI" }),
  ...
  define("purchase.order", "PurchaseOrder", "orderNo", "controllers/purchase/purchaseOrder.controller.js", { label: "Purchase Order No.", prefix: "PO", additionalProducers: ["services/purchase/purchaseExecution.service.js"] }),
  define("purchase.receipt", "GoodsReceipt", "receiptNo", "controllers/purchase/goodsReceipt.controller.js", { label: "Goods Receipt No.", prefix: "GRN" }),
  define("purchase.return", "PurchaseReturn", "returnNo", "controllers/purchase/purchaseReturn.controller.js", { label: "Purchase Return No.", prefix: "RET" }),
  ...
  define("purchase.quality", "PurchaseQualityInspection", "inspectionReference", "controllers/purchase/purchaseWorkflow.controller.js", { label: "Purchase Quality No.", prefix: "PQI" }),
  ...
  define("purchase.lc-application", "CommercialLC", "applicationNo", "controllers/purchase/commercialLC.controller.js", { label: "LC Application No.", prefix: "LCAPP", resetPolicy: "calendar_year" }),
  define("purchase.import-shipment", "ImportShipment", "shipmentNo", "controllers/purchase/importShipment.controller.js", { label: "Import Shipment No.", prefix: "IMPSHP", resetPolicy: "calendar_year" }),
  define("purchase.landed-cost", "LandedCost", "landedCostNo", "controllers/purchase/landedCost.controller.js", { label: "Landed Cost No.", prefix: "LDC", resetPolicy: "calendar_year" }),
  ...
  define("accounting.invoice", "Invoice", "invoiceNo", "controllers/crm/invoice.controller.js", { label: "Accounting Invoice No.", prefix: "INV", serialWidth: 6, resetPolicy: "fiscal_year", legacyFormatter: "accounting_fiscal" }),
  ...
  ...[
    ...
    ["inspection", "ManufacturingQualityInspection", "inspectionNumber", "QI"], ["ncr", "NonConformance", "ncrNumber", "NCR"],
  ...
  define("crm.lead", "Lead", "leadNumber", "models/crm/lead.model.js", { label: "Lead No.", prefix: "LD" }),
  ...
  define("crm.invoice", "Invoice", "invoiceNo", "controllers/crm/invoice.controller.js", { label: "CRM Invoice No.", prefix: "INV" }),
  define("payroll.loan", "EmployeeLoan", "loanNo", "controllers/payroll/employeeLoan.controller.js", { label: "Employee Loan No.", prefix: "LN" }),
  define("supplier.company", "Supplier", "code", "controllers/supplier/supplier.controller.js", { label: "Supplier Code", prefix: "SUP", mode: "manual", maxLength: 50 }),
  ...
  define("administration.employee", "User", "employeeId", "controllers/administration/user.controller.js", { label: "Employee Code", prefix: "EMP", mode: "manual", maxLength: 50 }),
]);
