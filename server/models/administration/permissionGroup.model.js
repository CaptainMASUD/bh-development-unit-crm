...
export const PERMISSION_KEYS = [
  ...
  "finance:credit-note:manage",
  "finance:debit-note:view",
  "finance:debit-note:manage",
  "finance:adjustment-note:view",
  "finance:adjustment-note:manage",
  "finance:payment-term:view",
  "finance:payment-term:manage",
  "finance:payment-schedule:manage",
  "tasks:view",
  "tasks:manage",
  "reports:view",
  "attendance:view",
