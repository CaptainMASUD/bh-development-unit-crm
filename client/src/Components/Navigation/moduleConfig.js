...
export const MODULES = {
  ...
  purchase: {
    ...
    permissions: [
      ...
      "commercial-lc:view", "commercial-lc:manage", "commercial-lc:approve", "commercial-lc:open", "commercial-lc:amend", "commercial-lc:settle", "commercial-lc:close",
      "purchase-request:view", "purchase-analysis:view", "purchase-issue:view", "purchase-quality:view", "purchase-due:view", "price-analysis:view", "purchase-type:view",
    ],
    adminSections: ["Dashboard", "Quick Purchase", "Purchase Operations", "Purchase Order Management", "Import & Commercial LC", "Financial / Review", "Purchase Returns", "Purchase Reports"],
    employeeSections: ["Dashboard", "Quick Purchase", "Purchase Operations", "Purchase Order Management", "Import & Commercial LC", "Financial / Review", "Purchase Returns", "Purchase Reports"],
    subcategories: {
      "Purchase Operations": ["Purchase Requests", "Purchase Analysis", "Purchase Issues", "Goods Receipts", "Quality Inspection"],
      "Purchase Order Management": ["Purchase Orders", "PO Print / PDF"],
      "Import & Commercial LC": ["Commercial LCs", "Import Shipments", "Import Documents", "Landed Costs"],
      "Financial / Review": ["Purchase Dues", "Price Analysis"],
    },
  },
  sales: {
    id: "sales",
  ...
  manufacturing: {
    id: "manufacturing",
    name: "Manufacturing",
    description: "Production planning, shop-floor execution, engineering, quality, maintenance, costing, and reporting.",
    permissions: [
    ...
    dashboardPermission: "manufacturing-report:view",
    useSectionDashboard: true,
    adminSections: ["Dashboard", "Planning", "Production", "Engineering", "Quality", "Maintenance", "Outsourcing", "Costing", "Reports"],
    employeeSections: ["Dashboard", "Planning", "Production", "Engineering", "Quality", "Maintenance", "Outsourcing", "Costing", "Reports"],
    sectionAliases: { Dashboard: "Manufacturing Dashboard", Reports: "Manufacturing Reports Group" },
    subcategories: {
