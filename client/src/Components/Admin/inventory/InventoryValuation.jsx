    ...
    >
      <div className="flex flex-col gap-3 border-b border-gray-100 p-5 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-3">
          <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-indigo-50 text-indigo-700 ring-1 ring-indigo-600/10">
            <Icon
              icon={DashboardSquare01Icon}
              className="h-5 w-5"
            />
          ...
          <div>
            ...
            <p className="mt-0.5 text-sm text-gray-500">
              Current weighted inventory value grouped by warehouse.
            </p>
          </div>
        </div>
              ...
              <tr>
                ...
                >
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    Warehouse values will appear after posted stock activity.
                  </p>
                </td>
              </tr>
            )}
...
function RecentMovementsReport({
  movements,
  loading,
}) {
  return (
    ...
    >
      <div className="flex flex-col gap-3 border-b border-gray-100 p-5 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-3">
          <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-sky-50 text-sky-700 ring-1 ring-sky-600/10">
            <Icon
              icon={
                ArrowDataTransferHorizontalIcon
              }
          ...
          <div>
            ...
            <p className="mt-0.5 text-sm text-gray-500">
              Permanent posted inventory activity.
            </p>
          </div>
        </div>
      ...
      movements.length ? (
        <div className="flex flex-col gap-2 border-t border-gray-100 px-4 py-3 sm:flex-row sm:items-center sm:justify-between">
          <p className="text-xs font-semibold text-gray-500">
            {movements.length} recent movement
            {movements.length === 1
              ? ""
              : "s"}{" "}
            shown
  ...
  const metrics = useMemo(
    () => [
      ...
      },
      {
        ...
        detail:
          "Weighted current inventory valuation",
        tone:
          "green",
        icon: (
          <Icon
      ...
      },
      {
        ...
        detail:
          "Excluded from usable availability",
        tone:
          "rose",
        icon: (
          <Icon
      ...
      },
      {
        ...
        detail:
          "Awaiting warehouse and bin assignment",
        tone:
          "sky",
        icon: (
          <Icon
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="min-w-0">
                ...
                <p className="mt-1 max-w-3xl text-sm text-gray-500">
                  Products, availability, valuation, replenishment alerts, transfers, and inventory activity.
                </p>
              </div>
            </div>
