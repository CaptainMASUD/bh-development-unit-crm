...
const PERMISSION_LABELS = {
  ...
  "bank-setup:view": { label: "View Bank Setup", helper: "See configured banks, company bank accounts, and linked accounting ledgers." },
  "bank-setup:manage": { label: "Manage Bank Setup", helper: "Create, update, connect, synchronize, and deactivate bank accounts and bank names." },
  ...
  "inventory-product:view": { label: "View Products", helper: "See inventory products and their stock-tracking details." },
  "inventory-product:manage": { label: "Manage Products", helper: "Create and update inventory products and tracking settings." },
  "inventory-product:delete": { label: "Archive Products", helper: "Archive and restore inventory products." },
  "inventory-category:view": { label: "View Product Categories", helper: "See the categories used to organize inventory products." },
  "inventory-category:manage": { label: "Manage Product Categories", helper: "Create and update inventory product categories." },
  "inventory-category:delete": { label: "Archive Product Categories", helper: "Archive and restore inventory product categories." },
  "inventory-brand:view": { label: "View Product Brands", helper: "See the brands assigned to inventory products." },
  "inventory-brand:manage": { label: "Manage Product Brands", helper: "Create and update inventory product brands." },
  "inventory-brand:delete": { label: "Archive Product Brands", helper: "Archive and restore inventory product brands." },
  "inventory-unit:view": { label: "View Inventory Units", helper: "See units of measure available for inventory products." },
  "inventory-unit:manage": { label: "Manage Inventory Units", helper: "Create and update inventory units of measure." },
  "inventory-unit:delete": { label: "Archive Inventory Units", helper: "Archive and restore inventory units of measure." },
  "inventory-warehouse:view": { label: "View Warehouses", helper: "See warehouses and their inventory settings." },
  "inventory-warehouse:manage": { label: "Manage Warehouses", helper: "Create and update warehouses and their settings." },
  "inventory-warehouse:delete": { label: "Archive Warehouses", helper: "Archive and restore warehouses." },
  "inventory-location:view": { label: "View Warehouse Locations", helper: "See storage locations within warehouses." },
  "inventory-location:manage": { label: "Manage Warehouse Locations", helper: "Create and update warehouse storage locations." },
  "inventory-location:delete": { label: "Archive Warehouse Locations", helper: "Archive and restore warehouse storage locations." },
  "inventory-stock:view": { label: "View Stock", helper: "See stock on hand, availability, valuation, and stock history." },
  "inventory-stock:manage": { label: "Manage Stock", helper: "Update stock-control records and inventory balances." },
  "inventory-stock:delete": { label: "Delete Stock Records", helper: "Remove eligible stock-control records." },
  "inventory-movement:view": { label: "View Stock Movements", helper: "See stock movement records and movement history." },
  "inventory-movement:manage": { label: "Manage Stock Movements", helper: "Create, edit, submit, and cancel draft stock movements." },
  "inventory-movement:post": { label: "Post Stock Movements", helper: "Post stock movements and apply their inventory changes." },
  "inventory-movement:reverse": { label: "Reverse Stock Movements", helper: "Reverse posted stock movements and their inventory changes." },
  "inventory-movement:delete": { label: "Delete Stock Movements", helper: "Delete eligible draft stock movement records." },
  "inventory-adjustment:view": { label: "View Stock Adjustments", helper: "See stock counts, variances, and adjustment history." },
  "inventory-adjustment:manage": { label: "Manage Stock Adjustments", helper: "Create, edit, submit, refresh, and cancel stock adjustments." },
  "inventory-adjustment:approve": { label: "Approve Stock Adjustments", helper: "Approve or reject submitted stock adjustments." },
  "inventory-adjustment:post": { label: "Post Stock Adjustments", helper: "Post approved adjustments and apply stock corrections." },
  "inventory-adjustment:reverse": { label: "Reverse Stock Adjustments", helper: "Reverse posted adjustments and their stock corrections." },
  "inventory-adjustment:delete": { label: "Delete Stock Adjustments", helper: "Delete eligible draft stock adjustment records." },
  "inventory-transfer:view": { label: "View Stock Transfers", helper: "See warehouse transfer records and transfer history." },
  "inventory-transfer:manage": { label: "Manage Stock Transfers", helper: "Create, edit, submit, and cancel warehouse transfers." },
  "inventory-transfer:approve": { label: "Approve Stock Transfers", helper: "Approve or reject submitted warehouse transfers." },
  "inventory-transfer:dispatch": { label: "Dispatch Stock Transfers", helper: "Dispatch approved transfers or post direct transfers." },
  "inventory-transfer:receive": { label: "Receive Stock Transfers", helper: "Receive dispatched stock and close short transfers." },
  "inventory-transfer:reverse": { label: "Reverse Stock Transfers", helper: "Reverse completed warehouse transfers." },
  "inventory-transfer:delete": { label: "Delete Stock Transfers", helper: "Delete eligible draft warehouse transfer records." },
  "inventory-report:view": { label: "View Inventory Reports", helper: "Open the inventory dashboard, stock summaries, and valuation reporting." },
  ...
  "company:view": { label: "View Company Setup", helper: "View the current company profile and its enabled ERP modules." },
  "company:manage": { label: "Manage Company Setup", helper: "Update the current company profile and operating defaults." },
  "branch:view": { label: "View Branches", helper: "View branches and the current default operating location." },
  "branch:manage": { label: "Manage Branches", helper: "Create and update branches within the current company." },
  "purchase-order:view": { label: "View Purchase Orders", helper: "See purchase orders, totals, supplier details, and order status." },
  "purchase-order:manage": { label: "Manage Purchase Orders", helper: "Create, edit, submit, cancel, and close purchase orders." },
  "purchase-order:approve": { label: "Approve Purchase Orders", helper: "Approve or reject submitted purchase orders." },
  "purchase-order:delete": { label: "Delete Purchase Orders", helper: "Delete eligible draft purchase orders." },
  "goods-receipt:view": { label: "View Goods Receipts", helper: "See received goods, inspection quantities, and posting status." },
  "goods-receipt:manage": { label: "Manage Goods Receipts", helper: "Create, edit, submit, and cancel goods receipts." },
  "goods-receipt:approve": { label: "Approve Goods Receipts", helper: "Approve submitted goods receipts after inspection." },
  "goods-receipt:post": { label: "Post Goods Receipts", helper: "Post approved receipts into inventory and accounting." },
  "goods-receipt:reverse": { label: "Reverse Goods Receipts", helper: "Reverse previously posted goods receipts." },
  "goods-receipt:delete": { label: "Delete Goods Receipts", helper: "Delete eligible draft goods receipts." },
  "purchase-return:view": { label: "View Purchase Returns", helper: "See supplier returns, quantities, values, and status." },
  "purchase-return:manage": { label: "Manage Purchase Returns", helper: "Create, edit, submit, and cancel purchase returns." },
  "purchase-return:approve": { label: "Approve Purchase Returns", helper: "Approve submitted supplier returns." },
  "purchase-return:post": { label: "Post Purchase Returns", helper: "Post approved returns into inventory and accounting." },
  "purchase-return:reverse": { label: "Reverse Purchase Returns", helper: "Reverse previously posted supplier returns." },
  "purchase-return:delete": { label: "Delete Purchase Returns", helper: "Delete eligible draft purchase returns." },
  "commercial-lc:view": { label: "View Commercial LCs", helper: "View import LCs, shipments, documents, landed costs, and settlement status." },
  "commercial-lc:manage": { label: "Manage Commercial LCs", helper: "Create and update LC applications, shipments, import documents, and landed costs." },
  "commercial-lc:approve": { label: "Approve Commercial LCs", helper: "Submit and approve eligible LC applications for opening." },
  "commercial-lc:open": { label: "Open Commercial LCs", helper: "Record bank opening details, LC margins, and opening charges." },
  "commercial-lc:amend": { label: "Amend Commercial LCs", helper: "Record controlled amendments and amendment charges." },
  "commercial-lc:settle": { label: "Settle Commercial LCs", helper: "Record supplier or bank settlement against eligible import LCs." },
  "commercial-lc:close": { label: "Close Commercial LCs", helper: "Close or cancel eligible Commercial LC records." },
  "purchase-request:view": { label: "View Purchase Requests", helper: "See purchase demand requests, required quantities, and status." },
  "purchase-request:manage": { label: "Manage Purchase Requests", helper: "Create, edit, and manage purchase requests." },
  "purchase-request:approve": { label: "Approve Purchase Requests", helper: "Approve or reject pending purchase requests." },
  "purchase-analysis:view": { label: "View Purchase Analysis", helper: "See supplier quotation comparisons, pricing, and demand analyses." },
  "purchase-analysis:manage": { label: "Manage Purchase Analysis", helper: "Create, update, and complete purchase analyses." },
  "purchase-issue:view": { label: "View Purchase Issues", helper: "See industrial and quick purchase issue drafts, status, and linked POs." },
  "purchase-issue:manage": { label: "Manage Purchase Issues", helper: "Create, draft, submit, and finalize purchase issues." },
  "purchase-quality:view": { label: "View Quality Inspections", helper: "See incoming purchase quality inspection records and results." },
  "purchase-quality:manage": { label: "Manage Quality Inspections", helper: "Record inspections, accepted, rejected, and quarantine quantities." },
  "purchase-due:view": { label: "View Purchase Dues", helper: "See outstanding supplier purchase dues and payment deadlines." },
  "purchase-due:pay": { label: "Pay Purchase Dues", helper: "Record full or partial payments against outstanding supplier dues." },
  "price-analysis:view": { label: "View Price Analysis", helper: "See variances between catalogue prices and purchase execution prices." },
  "price-analysis:review": { label: "Review Price Analysis", helper: "Review price variances and update supplier product catalogues." },
  "purchase-type:view": { label: "View Purchase Types", helper: "See configured procurement categories and purchase types." },
  "purchase-type:manage": { label: "Manage Purchase Types", helper: "Create and update procurement categories and purchase types." },
}
...
const MODULE_LABELS = {
  ...
  "commercial-lc": "Commercial LC & Import",
  "purchase-request": "Purchase Requests",
  "purchase-analysis": "Purchase Analysis",
  "purchase-issue": "Purchase Issues",
  "purchase-quality": "Quality Inspection",
  "purchase-due": "Purchase Dues",
  "price-analysis": "Price Analysis",
  "purchase-type": "Purchase Types",
  workflow: "Workflow",
  profile: "Profile",
}
...
export default function AccessControl() {
  ...
  const permissionSections = useMemo(() => {
    ...
    permissionCatalog.forEach((permission) => {
      const catalogModule = permission.module || String(permission.key || "").split(/[:.]/)[0]
      const moduleName = String(catalogModule).startsWith("inventory-") ? "inventory" : catalogModule
