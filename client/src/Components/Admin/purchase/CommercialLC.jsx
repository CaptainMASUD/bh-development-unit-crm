...
export default function CommercialLC() {
  ...
  const save = async (event) => {
    ...
    try {
      ...
      if (!body.applicationNo?.trim()) delete body.applicationNo
