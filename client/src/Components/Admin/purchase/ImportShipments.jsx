...
const blank = () => ({ shipmentMode: "sea", carrierName: "", vesselName: "", voyageNo: "", billOfLadingNo: "", airwayBillNo: "", bookingReference: "", portOfLoading: "", portOfDischarge: "", finalDestination: "", etd: "", eta: "", actualDepartureAt: "", actualArrivalAt: "", customsEntryNo: "", customsClearedAt: "", cnfAgentName: "", status: "planned", notes: "", containersText: "" })
...
export default function ImportShipments() {
  ...
  const save = async (event) => {
    ...
    try {
      const payload = { ...form, containers: containersFromText(form.containersText) }; delete payload.containersText
