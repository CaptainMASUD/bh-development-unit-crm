...
export default function GoodsReceipts({ initialPurchaseOrderId = "", onCreatePurchaseReturn }) {
  ...
  const buildPayload = () => ({
    ...(!formModal.item && clean(form.receiptNo) ? { receiptNo: clean(form.receiptNo).toUpperCase() } : {}),
