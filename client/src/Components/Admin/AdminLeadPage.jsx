...
function FiltersModal({ open, onClose, draft, setDraft, onApply, onClearDraft, activeSummary }) {
  ...
  return (
    <ModalShell
      ...
      onClose={onClose}
      title="Lead Filters"
      subtitle="Server-side search & ranges"
          ...
          <div className={cn(card, "overflow-hidden")}>
            <div className="px-4 py-3 border-b border-gray-100 bg-gray-50/70 flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-500">GET /api/leads query params</p>
              </div>
              {hasAnyDraft ? (
            ...
            <div className="p-4 space-y-4">
              ...
              <p className="text-xs text-gray-500">List stays clean — full details are inside View page.</p>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <button onClick={() => onDelete?.(lead)} className={cn(btn, btnDanger)} disabled={!lead}>
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className={cn(card, "p-5")}>
            ...
            <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-2">
              <button
                onClick={() => onMarkContacted?.(lead?._id)}
                disabled={!lead}
                className={cn(btn, btnGhost, "justify-start")}
              >
            ...
            <button
              onClick={() => showToast?.("success", "Tip: use Edit to update fields (PUT /api/leads/:id)")}
              className={cn("mt-3 w-full", btn, btnGhost)}
            >
              <FiEdit2 className="w-4 h-4" /> Tips
            </button>
          </div>
        </div>
      </div>
          ...
          <FiltersModal
            ...
            activeSummary={
              <div className="text-sm text-gray-700">
                <p className="font-bold text-gray-900">Draft</p>
                <p className="text-xs text-gray-500 mt-1">Apply to refresh list.</p>
              </div>
            }
          />
        ) : null}
              ...
              <div className="flex flex-col gap-4">
                <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">Clean list • Lead number shown only in Details</p>
                    </div>
                  </div>
                ...
                <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-center justify-between">
                  <div className="w-full lg:w-2/3">
                    ...
                    <p className="mt-2 text-xs text-gray-500">The list is minimal — open View to see full lead info.</p>
                  </div>
              ...
              <table className="w-full">
                <thead className="sticky top-0 z-10 bg-white/85 backdrop-blur border-b border-gray-100">
                  <tr>
                    ...
                    <th className="px-6 py-4 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Lead</th>
