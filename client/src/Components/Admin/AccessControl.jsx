...
const PERMISSION_LABELS = {
  ...
  "bank-setup:view": { label: "View Bank Setup", helper: "See configured bank names, types, countries, and SWIFT codes." },
  "bank-setup:manage": { label: "Manage Bank Setup", helper: "Create, update, and delete bank names." },
