export const PERMISSIONS = {
  ...
  CREDIT_NOTE_VIEW: "finance:credit-note:view",
  CREDIT_NOTE_MANAGE: "finance:credit-note:manage",
  DEBIT_NOTE_VIEW: "finance:debit-note:view",
  DEBIT_NOTE_MANAGE: "finance:debit-note:manage",
  ADJUSTMENT_NOTE_VIEW: "finance:adjustment-note:view",
  ADJUSTMENT_NOTE_MANAGE: "finance:adjustment-note:manage",
  PAYMENT_TERM_VIEW: "finance:payment-term:view",
  PAYMENT_TERM_MANAGE: "finance:payment-term:manage",
  PAYMENT_SCHEDULE_MANAGE: "finance:payment-schedule:manage",
